    ...
    <div class="two-column-layout">
                        ...
                        <tr>
                            <?php 
                                ...
                                if ( ( $action === 'update') && ( $opleiding->getID() === $get_array['id'] ) ) {
                                    ...
                                    <td><input type="submit" name="update-opleidingsnaam" value="Aanpassen" id="bewerken-opleidingsnaam" class="ivs-button"></td>
                                    <?php
                                } else {
                                    ?>
        ...
        <section>
            ...
            <form action="<?php echo $base_url; ?>" method="POST">
                ...
                <input type="submit" name="toevoegen-opleidingsnaam" id="toevoegen-meeloopdag" class="ivs-button" value="Toevoegen opleiding">
